# 📦 G-SERVER — Guide for FunPay Sellers

<div align="center">

![G-SERVER](https://img.shields.io/badge/G--SERVER-Bot-blueviolet?style=for-the-badge&logo=discord&logoColor=white)
![FunPay](https://img.shields.io/badge/FunPay-Lots-orange?style=for-the-badge)
![Templates](https://img.shields.io/badge/Templates-12-green?style=for-the-badge)
![Languages](https://img.shields.io/badge/Languages-RU%20%2F%20EN-blue?style=for-the-badge)
[![Website](https://img.shields.io/badge/Website-gserver.online-brightgreen?style=for-the-badge&logo=google-chrome&logoColor=white)](https://gserver.online/)

**Ready-made lot descriptions + Auto-delivery instructions for FunPay sellers**

</div>

---

> ## ⚠️ IMPORTANT FOR SELLERS — READ BEFORE CREATING LOTS!
>
> The lot descriptions in this document are **templates**.
> Before publishing, **be sure to change the lot title**, adding your unique emojis and words.
>
> ### ❌ Bad — looks the same for all sellers:
> ```
> 🎥 READY DISCORD SERVER — YouTube / Twitch | Auto-installation by bot
> ```
>
> ### ✅ Good — unique title:
> ```
> ⚡🎥 READY Discord server for Streamers | YouTube Twitch | Auto-setup in 30 sec!
> 🔥🎬 Discord server for YouTubers | Auto-bot | Channels + Roles in seconds!
> 🚀🎥 Discord setup for streamers | YouTube / Twitch | Fully automated!
> 💎🎥 Discord server for YouTube channel | Auto-setup | Roles + Channels ready!
> ```
>
> ### 💡 How to create a unique title:
> - Add **2-3 of your own emojis** at the beginning or end
> - Rephrase the text in your own words
> - Add clarifications: "in 30 sec", "turnkey", "for beginners", "pro setup"
> - Change the word order
>
> **The lot description** (text below the title) is also recommended to be changed slightly — at least the first 1-2 lines.

---

## 📋 Table of Contents

- [How Auto-Delivery Works](#-how-auto-delivery-works)
- [About G-SERVER Bot — Modules and Features](#-about-g-server-bot--modules-and-features)
- [List of Templates](#-list-of-templates)
- [Lot Descriptions](#-lot-descriptions)
  - [Lot 1 — YouTube / Twitch](#-lot-1--youtube--twitch)
  - [Lot 2 — Shop / Freelance](#-lot-2--shop--freelance)
  - [Lot 3 — Anime](#-lot-3--anime)
  - [Lot 4 — Community (Public)](#-lot-4--community-public)
  - [Lot 5 — Apex Legends](#-lot-5--apex-legends)
  - [Lot 6 — Valorant](#-lot-6--valorant)
  - [Lot 7 — CS2](#-lot-7--cs2)
  - [Lot 8 — Minecraft](#-lot-8--minecraft)
  - [Lot 9 — GTA V / SAMP](#-lot-9--gta-v--samp)
  - [Lot 10 — Mobile Legends](#-lot-10--mobile-legends)
  - [Lot 11 — Roblox](#-lot-11--roblox)
  - [Lot 12 — Rust](#-lot-12--rust)
- [Auto-Delivery Text](#-auto-delivery-text)
- [Instructions for Setting Up a Lot](#-instructions-for-setting-up-a-lot)
- [Tips for Sellers](#-tips-for-sellers)
- [❓ FAQ — Seller's Cheat Sheet](#-faq--sellers-cheat-sheet)
...
```
The buyer pays for the lot on FunPay
           ↓
FunPay automatically sends the link and instructions to the buyer
           ↓
The buyer invites the bot to their empty Discord server
           ↓
Types the command !wizard
           ↓
Selects language (🇷🇺 or 🇬🇧) and server template
           ↓
✅ The entire server is set up automatically in a few seconds!
```

> **You don't need to do anything manually!** The buyer gets a ready server without your participation.

---

## 🤖 About G-SERVER Bot — Modules and Features

> This will help you confidently answer buyer questions about the bot.

### 🧙 The !wizard command — main feature

`!wizard` is an interactive server setup wizard. One command creates the **entire server structure** from scratch:
- All categories and channels
- Full role hierarchy with permissions
- Basic automoderation
- All additional modules

The process takes **5–30 seconds** depending on the template size.

---

### 📦 Bot Modules — what is included in the server

| Module | Icon | Description | Plan |
|--------|--------|----------|-------|
| **Verification** | ✅ | Server entry button, bot protection | 🆓 Free |
| **Ticket System** | 🎫 | Private appeals to staff via a button | 🆓 Free |
| **Welcome** | 👋 | Beautiful welcome message for new members | 🆓 Free |
| **Reaction Roles** | 🎭 | Self-assign roles via reactions or buttons | 🆓 Free |
| **Autorole** | 🔄 | Automatic role assignment upon entry | 🆓 Free |
| **Suggestions** | 💡 | Channel for suggestions with voting | 🆓 Free |
| **Automoderation** | 🛡️ | Filter for spam, swearing, flood, links | ⭐ Premium |
| **Levels (XP)** | 📈 | Experience and leveling system for activity | ⭐ Premium |
| **Economy** | 💰 | Virtual currency, shop, jobs | ⭐ Premium |
| **Giveaways** | 🎉 | Create and run giveaways | ⭐ Premium |
| **Private Channels** | 🔊 | Temporary voice channels on demand | ⭐ Premium |
| **Starboard** | ⭐ | Best server messages | ⭐ Premium |
| **Moderation** | 🔨 | Ban, kick, mute, warns with logs | ⭐ Premium |
| **Logs** | 📋 | Full logging of server actions | ⭐ Premium |

> 🆓 **Free modules** always work, even after the subscription ends.
> ⭐ **Premium modules** are available for 30 days free after installation.

---

### 🌐 Dashboard (Control Panel)

The bot has a **web control panel** on the website [gserver.online](https://gserver.online/):
- Manage modules without commands
- Configure roles, channels, messages
- Server statistics
...
| | Description |
|-|-|
| **Trial period** | 30 days free upon installation |
| **Subscription** | 30-day key (activated in the dashboard) |
| **After expiration** | Free modules continue to work |
| **Activation** | Via the website gserver.online |
...
| No. | Emoji | Template | Description | 💰 Price |
|---|--------|--------|----------|---------|
| 1 | 🎥 | YouTube / Twitch | For streamers and YouTubers | 79 ₽ |
| 2 | 🛒 | Shop / Freelance | For online shops and freelancers | 89 ₽ |
| 3 | 🌸 | Anime | For anime communities | 69 ₽ |
| 4 | 🌍 | Community (Public) | Universal public server | 59 ₽ |
| 5 | 🎯 | Apex Legends | Apex Legends clan / community | 99 ₽ |
| 6 | 🔫 | Valorant | Valorant clan / community | 99 ₽ |
| 7 | 💣 | CS2 | CS2 clan / community | 99 ₽ |
| 8 | ⛏️ | Minecraft | Minecraft server or community | 79 ₽ |
| 9 | 🚗 | GTA V / SAMP | GTA V / SAMP RP server | 89 ₽ |
| 10 | 📱 | Mobile Legends | Mobile Legends clan / community | 89 ₽ |
| 11 | 🧱 | Roblox | For Roblox communities and gaming groups | 69 ₽ |
| 12 | ☢️ | Rust | Rust clan / community | 99 ₽ |

> 💡 **Recommendation:** Price gaming templates (CS2, Valorant, Apex, Rust) higher — there is more demand for them.

> All templates are available in **🇷🇺 Russian** and **🇬🇧 English**.

---

## 📝 Lot Descriptions

> Copy the desired text and paste it into the **"Description"** field of your lot on FunPay.
...
3️⃣ The bot will send a message with buttons:
   • Click 🇷🇺 for a Russian server
   • Click 🇬🇧 for an English server
   • Select the desired template from the menu
...
## 🛠️ Instructions for Setting Up a Lot

### Step 1 — Create a lot
1. Go to [funpay.com](https://funpay.com) → Your profile → **"My lots"**
2. Click **"Add lot"**
3. Category: `Discord → Servers / Design`
4. Title: `🎥 Ready Discord server — YouTube / Twitch | Auto-installation by bot`
5. Description: copy from the ["Lot Descriptions"](#-lot-descriptions) section above
6. Set the price → Save

### Step 2 — Set up auto-delivery
1. Open the lot settings
2. Turn on **"Automatic delivery"**
3. Paste the text from the ["Auto-Delivery Text"](#-auto-delivery-text) section

### Step 3 — Example lot
```
Title:          🎥 Ready Discord server | YouTube / Twitch | Auto-bot
...
- 💡 Create a **separate lot** for each template — more lots = more sales
- 💡 Price gaming templates (CS2, Valorant) **higher**, general ones — lower
- 💡 Add **screenshots** of the ready server to the lot gallery
- 💡 Write in the title: **"No waiting — fully automatic!"**
- 💡 Answer questions quickly — this increases the seller's rating
- 💡 Offer a discount when buying multiple templates at once

---

## ❓ FAQ — Seller's Cheat Sheet

> Frequent questions from buyers and ready answers for them.

<details>
<summary><b>❓ Is the bot safe? Will it harm my server?</b></summary>

```
Yes, the bot is completely safe. It only creates the server structure (channels, roles,
categories). It does not read your messages and does not collect data.
Proof: the bot works on more than 500 servers.
```

</details>

<details>
<summary><b>❓ Why does the bot need Administrator permissions?</b></summary>

```
Administrator permissions are only needed for the initial setup — creating channels,
roles, and categories. After installation, you can downgrade the bot's permissions to a regular
member if you want.
```
...
<details>
<summary><b>❓ Will the bot delete my existing channels?</b></summary>

```
The bot DOES NOT automatically delete existing channels. We recommend running !wizard
on an empty server for the best results. If the server already has channels,
the new ones will be added alongside the existing ones.
```

</details>

<details>
<summary><b>❓ Can I change channels and roles after installation?</b></summary>

```
Yes! After installation, you become the full owner of the server. You can
rename, delete, and add channels and roles at any time through
regular Discord settings.
```

</details>

<details>
<summary><b>❓ What is Premium? Is it required?</b></summary>

```
Premium includes advanced bot features (automoderation, leveling, economy,
giveaways, etc.). No, it is not required! After installation, you get
30 days of Premium for free. After expiration — basic modules (tickets,
verification, welcome, reaction roles) remain free forever.
```
